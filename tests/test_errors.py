from keysight_b1530a.errors import WGFMUError, check_error, ERROR_MESSAGES
import pytest
...
@pytest.mark.parametrize("error_code, expected_message", [
    ...
    (-999, "Unknown error code: -999"),  # Assuming unknown error codes have a default message
])
