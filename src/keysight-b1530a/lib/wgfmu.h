...
static const int WGFMU_WARNING_LEVEL_OFF				= 1000;
static const int WGFMU_WARNING_LEVEL_SEVERE				= 1001;
static const int WGFMU_WARNING_LEVEL_NORMAL				= 1002;
static const int WGFMU_WARNING_LEVEL_INFORMATION		= 1003;

// WGFMU_setOperationMode
static const int WGFMU_OPERATION_MODE_OFFSET			= 2000;
static const int WGFMU_OPERATION_MODE_DC				= 2000;
static const int WGFMU_OPERATION_MODE_FASTIV			= 2001;
static const int WGFMU_OPERATION_MODE_PG				= 2002;
static const int WGFMU_OPERATION_MODE_SMU				= 2003;

// WGFMU_setForceVoltageRange
static const int WGFMU_FORCE_VOLTAGE_RANGE_OFFSET		= 3000;
static const int WGFMU_FORCE_VOLTAGE_RANGE_AUTO			= 3000;
static const int WGFMU_FORCE_VOLTAGE_RANGE_3V			= 3001;
static const int WGFMU_FORCE_VOLTAGE_RANGE_5V			= 3002;
static const int WGFMU_FORCE_VOLTAGE_RANGE_10V_NEGATIVE	= 3003;
static const int WGFMU_FORCE_VOLTAGE_RANGE_10V_POSITIVE	= 3004;

// WGFMU_setMeasureMode
static const int WGFMU_MEASURE_MODE_OFFSET				= 4000;
static const int WGFMU_MEASURE_MODE_VOLTAGE				= 4000;
static const int WGFMU_MEASURE_MODE_CURRENT				= 4001;

// WGFMU_setMeasureVoltageRange
static const int WGFMU_MEASURE_VOLTAGE_RANGE_OFFSET		= 5000;
static const int WGFMU_MEASURE_VOLTAGE_RANGE_5V			= 5001;
static const int WGFMU_MEASURE_VOLTAGE_RANGE_10V		= 5002;

// WGFMU_setMeasureCurrentRange
static const int WGFMU_MEASURE_CURRENT_RANGE_OFFSET		= 6000;
static const int WGFMU_MEASURE_CURRENT_RANGE_1UA		= 6001;
static const int WGFMU_MEASURE_CURRENT_RANGE_10UA		= 6002;
static const int WGFMU_MEASURE_CURRENT_RANGE_100UA		= 6003;
static const int WGFMU_MEASURE_CURRENT_RANGE_1MA		= 6004;
static const int WGFMU_MEASURE_CURRENT_RANGE_10MA		= 6005;

// WGFMU_setMeasureEnabled
static const int WGFMU_MEASURE_ENABLED_OFFSET			= 7000;
static const int WGFMU_MEASURE_ENABLED_DISABLE			= 7000;
static const int WGFMU_MEASURE_ENABLED_ENABLE			= 7001;

// WGFMU_setTriggerOutMode
static const int WGFMU_TRIGGER_OUT_MODE_OFFSET			= 8000;
static const int WGFMU_TRIGGER_OUT_MODE_DISABLE			= 8000;
static const int WGFMU_TRIGGER_OUT_MODE_START_EXECUTION = 8001;
static const int WGFMU_TRIGGER_OUT_MODE_START_SEQUENCE	= 8002;
static const int WGFMU_TRIGGER_OUT_MODE_START_PATTERN	= 8003;
static const int WGFMU_TRIGGER_OUT_MODE_EVENT			= 8004;

static const int WGFMU_TRIGGER_OUT_POLARITY_OFFSET		= 8100;
static const int WGFMU_TRIGGER_OUT_POLARITY_POSITIVE	= 8100;
static const int WGFMU_TRIGGER_OUT_POLARITY_NEGATIVE	= 8101;

// WGFMU_createMergedPattern
static const int WGFMU_AXIS_OFFSET						= 9000;
static const int WGFMU_AXIS_TIME						= 9000;
static const int WGFMU_AXIS_VOLTAGE						= 9001;

// WGFMU_getStatus, WGFMU_getChannelStatus
static const int WGFMU_STATUS_OFFSET					= 10000;
static const int WGFMU_STATUS_COMPLETED					= 10000;
static const int WGFMU_STATUS_DONE						= 10001;
static const int WGFMU_STATUS_RUNNING					= 10002;
static const int WGFMU_STATUS_ABORT_COMPLETED			= 10003;
static const int WGFMU_STATUS_ABORTED					= 10004;
static const int WGFMU_STATUS_RUNNING_ILLEGAL			= 10005;
static const int WGFMU_STATUS_IDLE						= 10006;

// WGFMU_isMeasureEventCompleted
static const int WGFMU_MEASURE_EVENT_OFFSET				= 11000;
static const int WGFMU_MEASURE_EVENT_NOT_COMPLETED		= 11000;
static const int WGFMU_MEASURE_EVENT_COMPLETED			= 11001;

// WGFMU_setMeasureEvent
static const int WGFMU_MEASURE_EVENT_DATA_OFFSET		= 12000;
static const int WGFMU_MEASURE_EVENT_DATA_AVERAGED		= 12000;
static const int WGFMU_MEASURE_EVENT_DATA_RAW			= 12001;
